...
/** Static default CSV outputs per API (can be overridden per call). */
const DEFAULT_RANDOM_STATS_CSV_PATH = './exports/random-active-ranked-player-stats.csv';
const DEFAULT_BY_ID_STATS_CSV_PATH = './exports/active-ranked-player-by-id-stats.csv';
const DEFAULT_FACTION_HOF_STATS_CSV_PATH = './exports/faction-hof-rank-player-stats.csv';
