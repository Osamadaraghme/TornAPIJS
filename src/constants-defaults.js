/**
 * Built-in defaults for application and Torn API constants.
 * Runtime effective values come from `getMergedConstants()` in `constants.js`
 * (merges these defaults with overrides in `data/tornapijs-control.sqlite`).
 */
